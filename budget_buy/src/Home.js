      ...
      <div className="home_container">
        ...
        <div className="home_row">
          ...
          <Product
            id="13"
            title="WROGN : 
            Men Blue Slim Fit Mid-Rise Clean Look Stretchable Jeans"
            price={2059}
        ...
        <div className="home_row">
          ...
          <Product
            id="15"
            title="SASSAFRAS : 
            Navy Blue Maxi Skirt with Suspenders"
            price={1645}
          ...
          <Product
            ...
            Men Navy Blue Embroidered Nehru Jacket"
            price={1245}
          ...
          <Product
            id="17"
            title="Belle Fille : 
            Women Multicoloured Printed Shorts"
            price={589}
          ...
          <Product
            id="18"
            title="ONN : 
            Men Pack of 2 Navy Printed Boxers ONN_ITALIA_NP969_PR2_PR5"
            price={499}
